  ...
  return (
    <div className="site-shell">
      ...
      <header className="nav container">
        <a className="brand" href="#top" aria-label="MA10 home">
      ...
      <main id="top">
        ...
        <section className="hero container">
          ...
          <div className="hero-visual" aria-label="MA10 artwork">
          ...
          <div className="about-content">
            <div className="about-main">
              ...
              <p className="section-copy">
                ...
                Python, Data Science and software development while
                building projects that turn ideas into working
                applications.
              </p>
            </div>
